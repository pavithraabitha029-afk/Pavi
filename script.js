...
<body>
  ...
  <main class="container">
    ...
    <section id="about" class="card">
      ...
      <p class="lead">Hello! I am <strong>Pavithra P</strong>, passionate about technology, coding, and design. I enjoy learning new skills and working on creative projects that make a difference.</p>
    ...
    <section id="contact" class="card">
      ...
      <p class="muted">LinkedIn: <a href="#" target="_blank" rel="noopener">linkedin.com/in/pavithra-p</a></p>
  ...
  <!-- JavaScript for nav, smooth scroll, form validation -->
  ...
  <script>
    ...
    (function(){
      ...
      form.addEventListener('submit', (e)=>{
        ...
        if (message.length < 10){ status.textContent = 'Message should be at least 10 characters.'; return; }
